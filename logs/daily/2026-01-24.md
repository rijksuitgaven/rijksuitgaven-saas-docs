...
**Correct setup:** Add custom domain in Railway first, then use Railway-provided CNAME target.

| Step | Action |
|------|--------|
| 1. Railway | Add `beta.rijksuitgaven.nl` as custom domain in Railway dashboard |
| 2. Railway provides | CNAME target: `j65ghs38.up.railway.app` |
| 3. DNS (Vimexx) | Add CNAME record: `beta` → `j65ghs38.up.railway.app` |
